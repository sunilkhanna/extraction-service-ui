...
import RetrainControls from "./RetrainControls";
...
export default function CanvasContainer() {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      if (isPDF) {
        // Backend should generate image (e.g., TIFF thumbnail) for PDF and return a URL or base64 image
        ...
        // Assume backend returns a base64 preview image of first page
